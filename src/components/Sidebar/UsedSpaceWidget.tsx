    ...
    <div>
      <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
        ...
        <div className="space-x-3">
          <button
            type="button"
            className="text-sm font-medium text-violet-500 hover:text-violet-700 dark:text-zinc-400 dark:hover:text-zinc-500"
          >
            Dismiss
          </button>
          <button
            type="button"
            className="text-sm font-medium text-violet-700 hover:text-violet-900 dark:text-violet-400 dark:hover:text-violet-500"
          >
            Upgrade plan
          </button>
        </div>
